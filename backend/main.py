...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://www.boostaiconsulting.com", "http://localhost:8080", "http://localhost:8081"],
...
@app.get("/test")
def test():
    return {"message": "Backend is working!", "cors_origins": ["https://www.boostaiconsulting.com", "http://localhost:8080", "http://localhost:8081"]}
